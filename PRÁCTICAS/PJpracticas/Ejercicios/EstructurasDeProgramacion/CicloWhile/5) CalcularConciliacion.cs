...
float.TryParse(Console.ReadLine(), out balance); // Leer el balance actual y pasarlo a float

Console.Write("Ingresa el pago a realizar: ");
float.TryParse(Console.ReadLine(), out pagoRealizado); // Leer el pago realizado y pasarlo a float
...
Console.WriteLine($"Apellido del cliente: {apellidoCliente}");
